...
function TasksList() {
  // We use the useSelector hook to get the state of the tasks slice.
  ...
  return (
    <div className="w-4/6">
      ...
      {/* Here we are using the map method to loop through the tasks array and render a list of tasks. */}
